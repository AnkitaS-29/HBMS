...
{
    public class HotelEmployeeController : Controller
    {
        ...
        {
            ViewBag.RoomID = new SelectList(db.RoomDetails180625, "RoomID", "RoomID");
            ViewBag.UserID = new SelectList(db.Users180625, "UserID", "UserID");
            return View();
        }
        ...
        public ActionResult BookHotel([Bind(Include = "BookingID,RoomID,UserID,Booked_From,Booked_To,No_of_Adults,No_of_Children,Amount")] BookingDetails180625 BookingDetails180625)
        {
            ...
            ViewBag.UserID = new SelectList(db.Users180625, "UserID", "UserID", BookingDetails180625.UserID);
            ViewBag.RoomID = new SelectList(db.RoomDetails180625, "RoomID", "RoomID", BookingDetails180625.RoomID);
            return View(BookingDetails180625);
        }
        //[HttpPost]
        //public ActionResult BookHotel(int RoomID,int UserID,DateTime Booked_From, DateTime Booked_To,int No_of_Adults,int No_of_Children,int Amount)
        //{
